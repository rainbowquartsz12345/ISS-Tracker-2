        ...
        return (
            <View>
                <ImageBackground style={styles.backgroundImage} source={bgimg} >
                    <View style={styles.gifContainern}>
                    ...
                    <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                        Closest to Earth - {' '} {item.close_approach_data[0].close_approach_date}
                    </Text>
                    <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                        Minimum Diameter (KM) -{' '} {item.estimated_diameter.miles.estimated_diameter_min}
                    </Text>
                    <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                        Maximum Diameter (KM) -{' '} {item.estimated_diameter.miles.estimated_diameter_max}
                    </Text>
                    <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
